...
public class TestHerokuPage {
    ...
    public void createTestForReport(ITestContext testContext){
        extentTest = extReport.createTest(testContext.getName()).log(Status.INFO,"Explore the UI: The Internet - HeroKu");
   ...
   public void SplitTest() throws InterruptedException {
        ...
        objUtil.saveScreenPrints(driver,Thread.currentThread().getStackTrace()[1].getMethodName()); *****/
        extentTest.log(Status.INFO,
                "A/B Testing page opened",
                MediaEntityBuilder.createScreenCaptureFromBase64String(takesScreenshot.getScreenshotAs(OutputType.BASE64),"AB_Testing").build());
        ...
        extentTest.log(Status.PASS,
                infomation,
                MediaEntityBuilder.createScreenCaptureFromBase64String(element.getScreenshotAs(OutputType.BASE64),"Gallery Section").build());
    ...
    public void AddRemoveElement() throws InterruptedException {
        ...
        extentTest.log(Status.INFO,
                "Add/Remove Elements Page opened ",
                MediaEntityBuilder.createScreenCaptureFromBase64String(takesScreenshot.getScreenshotAs(OutputType.BASE64),"Add/Remove").build());
        ...
        extentTest.log(Status.INFO,
                ...
                MediaEntityBuilder.createScreenCaptureFromBase64String(takesScreenshot.getScreenshotAs(OutputType.BASE64),"AddButoonClick").build());
        ...
        extentTest.log(Status.INFO,
                ...
                MediaEntityBuilder.createScreenCaptureFromBase64String(takesScreenshot.getScreenshotAs(OutputType.BASE64),"DeleteClicked").build());
    ...
    public void BasicAuth(String userName, String password, String expMessage) throws InterruptedException {
        ...
        extentTest.pass("Basic Auth done ",
                MediaEntityBuilder.createScreenCaptureFromBase64String(takesScreenshot.getScreenshotAs(OutputType.BASE64),"BasicAuth").build());
    ...
    public void CheckBoxOperations() throws InterruptedException {
        ...
        Thread.sleep(sleepTime);
        extentTest.log(Status.INFO,
                "Check box Page opened ",
                MediaEntityBuilder.createScreenCaptureFromBase64String(takesScreenshot.getScreenshotAs(OutputType.BASE64),"CheckBox").build());
        ...
        extentTest.log(Status.INFO,
                "Check box1 checked",
                MediaEntityBuilder.createScreenCaptureFromBase64String(takesScreenshot.getScreenshotAs(OutputType.BASE64),"CheckBox1").build());
        ...
        extentTest.log(Status.INFO,
                "Check box2 unchecked",
                MediaEntityBuilder.createScreenCaptureFromBase64String(takesScreenshot.getScreenshotAs(OutputType.BASE64),"CheckBox2").build());
    ...
    public void ContextMenu() throws InterruptedException {
        ...
        extentTest.log(Status.PASS,
                ...
                MediaEntityBuilder.createScreenCaptureFromBase64String(takesScreenshot.getScreenshotAs(OutputType.BASE64),"ContextCompleted").build());
    ...
    public void DisappearingElement() throws InterruptedException {
        ...
        extentTest.log(Status.INFO,
                "Disappearing Elements page opened",
                MediaEntityBuilder.createScreenCaptureFromBase64String(takesScreenshot.getScreenshotAs(OutputType.BASE64),"DisappearingElementsPage").build());
        ...
        try {
            ...
            extentTest.log(Status.PASS,
                    "Gallery section is available in this test run and did not dissapear",
                    MediaEntityBuilder.createScreenCaptureFromBase64String(elementGallery.getScreenshotAs(OutputType.BASE64),"Gallery Section").build());
            ...
            extentTest.fail(NoSuchElementException,MediaEntityBuilder.createScreenCaptureFromBase64String(takesScreenshot.getScreenshotAs(OutputType.BASE64)).build());
        }
        softAssert.assertAll();
    ...
    public void DragAndDrop() throws InterruptedException {
        ...
        extentTest.log(Status.INFO,
                ...
                MediaEntityBuilder.createScreenCaptureFromBase64String(takesScreenshot.getScreenshotAs(OutputType.BASE64),"DragDropPage").build());
        ...
        extentTest.log(Status.INFO,
             "Drag and Drop actioned",
                     MediaEntityBuilder.createScreenCaptureFromBase64String(takesScreenshot.getScreenshotAs(OutputType.BASE64),"AfterDragDropAction").build());
    ...
    public void DropDownListOperations() throws InterruptedException {
        ...
        extentTest.log(Status.INFO,
                "Dropdown List page opened",
                MediaEntityBuilder.createScreenCaptureFromBase64String(takesScreenshot.getScreenshotAs(OutputType.BASE64),"DropDownPage").build());
        ...
        extentTest.log(Status.INFO,
                "Option 1 selected",
                MediaEntityBuilder.createScreenCaptureFromBase64String(takesScreenshot.getScreenshotAs(OutputType.BASE64),"Option1").build());
        Thread.sleep(sleepTime);

        drList.selectByVisibleText("Option 2");
        extentTest.log(Status.INFO,
                "Option 2 selected",
                MediaEntityBuilder.createScreenCaptureFromBase64String(takesScreenshot.getScreenshotAs(OutputType.BASE64),"Option2").build());
        Thread.sleep(sleepTime);
